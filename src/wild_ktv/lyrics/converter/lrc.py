...
from .. import LyricsLine, MultiLyricsData
from . import LyricsFormat
from ...utils.time import get_divmod_time, ms2formattime

from .share import get_lyrics_lines

cfg_lrc_ms_digit_count = 3
cfg_add_end_timestamp_line = False
cfg_last_ref_line_time_sty = 0
...
def lrc_converter(tags: dict[str, str],
    ...
    lrc_ms_digit_count: int = cfg_lrc_ms_digit_count
    ms_converter = ms2formattime_2ms_digit if lrc_ms_digit_count == 2 else ms2formattime
    add_end_timestamp_line: bool = cfg_add_end_timestamp_line
    last_ref_line_time_sty: int = cfg_last_ref_line_time_sty
